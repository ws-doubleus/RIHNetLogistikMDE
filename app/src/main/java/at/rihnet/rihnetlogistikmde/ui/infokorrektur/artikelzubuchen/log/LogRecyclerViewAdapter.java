...
public class LogRecyclerViewAdapter extends RecyclerView.Adapter<LogRecyclerViewAdapter.LogHolder>{
    ...
    public void setOnItemClickListener(LogRecyclerViewAdapter.OnItemClickListener listener) {
        mListener = listener;
    }
    ...
    public static class LogHolder extends RecyclerView.ViewHolder {
        ...
        public LogHolder(@NonNull View itemView, LogRecyclerViewAdapter.OnItemClickListener listener) {
            super(itemView);
    ...
    @Override
    public void onBindViewHolder(@NonNull LogRecyclerViewAdapter.LogHolder logHolder, int position) {
