package at.rihnet.rihnetlogistikmde.ui.infokorrektur.artikelzubuchen.log;
...
public class LogFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArtikelZubuchenViewModel artikelZubuchenViewModel = new ViewModelProvider(requireActivity()).get(ArtikelZubuchenViewModel.class);
        artikelZubuchenViewModel.getLog().observe(getViewLifecycleOwner(), l -> {
            logList = l;
        ...
        btn_delete.setOnClickListener(v -> {
            ...
            executor.execute(() -> logDAO.deleteLogByKategorie(Kategorie.ARTIKELZUBUCHEN));
        });
        ...
        executor.execute(() -> {
            List<Log> logs = logDAO.getLogByKategorie(Kategorie.ARTIKELZUBUCHEN);
            handler.post(() -> {
                logList.clear();
                logList.addAll(logs);
                artikelZubuchenViewModel.setLog(logList);
