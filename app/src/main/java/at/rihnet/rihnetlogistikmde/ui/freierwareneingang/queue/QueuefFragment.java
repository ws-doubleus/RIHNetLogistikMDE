package at.rihnet.rihnetlogistikmde.ui.freierwareneingang.queue;
...
import at.rihnet.rihnetlogistikmde.databinding.FragmentQueuefBinding;
...
public class QueuefFragment extends Fragment implements MenuProvider {
    private final String TAG = "RIHNet";
    private SharedPreferences prefs;
    private LoadingDialogFragment loadingDialogFragment;
    private FragmentQueuefBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentQueuefBinding.inflate(inflater, container, false);

        loadingDialogFragment = LoadingDialogFragment.newInstance("Wareneingang wird angelegt...");
        loadingDialogFragment.setCancelable(true); //TODO false
    ...
    public class CreateWareneinganAsyncTask extends AsyncTaskExecutorService<Void, Artikel, String> {
        ...
        protected void onPostExecute(String documentNumber) {
            ...
            if (!documentNumber.isEmpty()) {
                if (success == all) {
                    log = new Log("Belegnummer: " + documentNumber + "\nBelegpositionen: " + success + " / " + all + "\nWareneingang erfolgreich!", ContextCompat.getColor(requireContext(), R.color.green_500), Kategorie.FREIERWARENEINGANG);
                    beleg.setLieferscheinnummer("");
                    freierWareneingangViewModel.setBeleg(beleg); //TODO bottom nav-beleg => lieferscheinnummer wird nicht "" gesetzt!!!
                    Beleg b = belegDAO.getBeleg();
